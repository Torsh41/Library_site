      ...
      $.ajax({
        ...
        success: function(response) {
            ...
            categories.forEach(category => {
                html += `<li class="category__elem" id="${category.id}category_info"><a href="/category/${category.id}" class="about__book-link"><div class="category__block">${category.name}</div></a></li>`;
            });
